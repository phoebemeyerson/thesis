...
# percent relative bias boxplot
ggplot(prior_metrics, aes(group = priors, y = prb)) + 
  geom_boxplot() + geom_hline(yintercept = 0)  

# confidence interval coverage boxplot
ggplot(prior_metrics, aes(group = priors, y = cov_rate)) + 
  geom_boxplot() + geom_hline(yintercept = 0.95) 

# mse boxplot
ggplot(prior_metrics, aes(group = priors, y = emp_mse)) + 
  geom_boxplot() + geom_hline(yintercept = 0) 

# percent relative bias mse boxplot
ggplot(prior_metrics, aes(group = priors, y = prb_var)) + 
  geom_boxplot() + geom_hline(yintercept = 0) 
```
